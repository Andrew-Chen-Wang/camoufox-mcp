...
function includeRequest(request: playwright.Request, response: playwright.Response | null, includeStatic: boolean, filter: string | undefined) {
...
function renderRequest(request: playwright.Request, response: playwright.Response | null, includeBody: boolean, includeHeaders: boolean) {
  const result: string[] = [];
