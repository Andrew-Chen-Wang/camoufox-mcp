...
export async function createMCPHTTPServer(options: CreateMCPHTTPServerOptions = {}): Promise<http.Server> {
...
function mergeConfig(config: Config | undefined, headless: boolean | undefined): Config {
